<template>
 <div>
    ...
    <div class="btn_wrap">
            <mt-button type="danger" size='large' class="back" @click='chong()'>充值</mt-button>
    </div>
    <div id="box2" :style='[b]'>
            {{msg}}
    </div>
                   ...
                   var _this=this;
                     _this.b={display:'block'};
                        ...
                        function f(){
                            ...
                            _1this.$store.commit("addqian",[_1this.num1,_1this.$store.state.phoneNum])
